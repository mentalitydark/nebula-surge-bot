...
import { AttachmentBuilder, channelMention, Events, type Guild, PermissionFlagsBits, type TextChannel, time, TimestampStyles, userMention } from 'discord.js'
...
export class RemoveMessage {
  ...
  private async getChannelMessagesRemoved(guild: Guild): Promise<TextChannel | null> {
